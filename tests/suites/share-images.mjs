...
// 73: five category pages since the landing page came apart, plus the article
// about it — two locales each.
ck('every built page was found', pages.length === 73, `${pages.length} pages`);
