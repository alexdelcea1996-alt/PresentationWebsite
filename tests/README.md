...
1702 de verificări care rulează peste site-ul construit, majoritatea cu un browser real.
...
| `guarantees` | secțiunea de garanții, ambele coloane, și că nu au rămas casete goale; plus că ce numește hero-ul „garantat" e scris în garanții, cu aceeași cifră, cu testul numit și cu telefonul inclus, iar coloana de alături spune unde se oprește promisiunea; și că orice paragraf din site care leagă testul de viteză de predare poartă aceeași cifră — în garanții, în „Despre mine" și pe paginile de serviciu | 36 |
