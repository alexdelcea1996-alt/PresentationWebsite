...
- **392 de verificări** rulate cu `npm test`, din repo: accesibilitate (18 pagini
  ...
  partajare (14), studiu de caz (19), demo-ul de aplicație (91), audit (4 fără
  cheie / 30 cu ea)
...
9. ✅ Pachet de completitudine: 404, set de iconuri, `manifest.json`, schema `FAQPage`
   ...
   aveau
10. ✅ Suita de teste publicată în repo, cu `npm test` — 392 de verificări
